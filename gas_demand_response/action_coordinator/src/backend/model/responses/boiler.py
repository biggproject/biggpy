...
@dataclass
class Boiler:
    """ The response of the boiler aggregator api contains boiler data, the data fields are included in this dataclass
    """
    ...
    # eg ...
    t_out2: float = None
    # eg. boiler_id_e8:31:cd:af:12:44/ot/boiler/status - NOT NEEDED
    # topic: str = None
